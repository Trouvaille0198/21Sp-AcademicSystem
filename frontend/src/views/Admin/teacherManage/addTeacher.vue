  ...
  <div>
    <el-card>
      <el-form style="width: 60%" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item>
          <el-button type="primary" @click="submitForm('ruleForm')">添加教师</el-button>
        </el-form-item>
  ...
  methods: {
    ...
    async submitForm(formName) {
      ...
      // 第2步：通过api添加教师
          var config = {
            method: 'post',
            url: 'http://1.15.130.83:8080/api/v1/teacher',
            data : {
              age : parseInt(newage),
          ...
          await axios(config).then(function (resp) {
            console.log("添加教师的resp.data.msg：" + resp.data.msg)  // 测试
            if (resp.data.code === 0) {
              that.$message({
                showClose: true,
                message: '添加教师成功',
